...
<div class="main-header">
    ...
    <p>Tác giả: Nguyễn Kiều Oanh Trường tiểu học Minh Ngọc xã Minh Ngọc</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© Nguyễn Kiều Oanh Trường tiểu học Minh Ngọc xã Minh Ngọc</div>", unsafe_allow_html=True)
